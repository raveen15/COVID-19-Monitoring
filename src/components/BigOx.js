...
import { VictoryLabel, VictoryChart, VictoryBar, VictoryPie, VictoryGroup, VictoryTheme, VictoryAxis, VictoryLine } from "victory-native";
...
export default class OxChart extends React.Component {
    ...
    constructor() {
      ...
      render() {
        return (
          <VictoryChart domain={{y: [0, 120]}} width={390} height={650} theme={VictoryTheme.material}>
            ...
            <VictoryLine
              ...
              y="num"
            />
            <VictoryLabel text="Blood Oxygen" x={200} y={30} textAnchor="middle" style={{ fontWeight: 'bold' }}/>
          </VictoryChart>
        );
      }
    }
